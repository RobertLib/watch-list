...
- ⚡ **Performance Optimization**:
  - Intelligent caching of streaming provider data (10-minute cache)
...
│   ├── usePageProviders.ts # Page-level provider management
│   └── useVideoOverlay.ts # Video overlay state
├── lib/             # Utility functions
│   ├── providers-cache.ts # Streaming provider caching
