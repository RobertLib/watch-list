...
export function FilterBar({ type, onFiltersChange }: FilterBarProps) {
  ...
  const updateFilters = (newParams: Record<string, string>) => {
    ...
    // Reset page and preset when filters change
    params.delete("page");
    ...
    if (onFiltersChange) {
      ...
      const filters: FilterOptions = {
        ...
        // When the selected year is the current year, cap the upper date bound to
        // today so that unreleased/future titles are excluded from results.
