/**
 * The detail page while it is still loading.
 *
 * One skeleton for films and series: the pages differ by a metadata chip and a
 * crew row, which is not worth two near-identical files of placeholder divs.
 */
        ...
        <div className="relative z-10 container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl">
            ...
            <div className="md:col-span-2 text-white">
              ...
              {/* Metadata: year(s), runtime, rating – a series carries more */}
