...
import { searchMulti, searchPerson } from "@/lib/api";
...
export function Navigation() {
  ...
  const isActiveLink = (href: string) => {
    ...
    if (href === "/moods") {
      return pathname === "/moods" || pathname.startsWith("/mood");
    }
    if (href === "/people") {
  ...
  // Close mobile menu when pathname changes. Done during the render that first
  // sees the new route rather than in an effect afterwards, so the menu is never
  // briefly still open over the page it has already navigated to.
          ...
          >
            ...
            >
              ...
              <Link
                ...
                aria-current={isActiveLink("/moods") ? "page" : undefined}
              >
