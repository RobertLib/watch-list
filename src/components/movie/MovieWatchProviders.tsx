...
// Given its providers rather than fetching them: the detail page already asked
// TMDB for `watch/providers` alongside everything else, so this section costs no
// request of its own.
