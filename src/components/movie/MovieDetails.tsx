...
function MovieDetailsContent({ details, certification }: MovieDetailsProps) {
...
export function MovieDetails({ details, certification }: MovieDetailsProps) {
  return (
    <MovieDetailsContent details={details} certification={certification} />
  );
}
