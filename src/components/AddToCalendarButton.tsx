 ...
 *
 * It is a snapshot: it holds the episodes that were scheduled the day it was
 * saved and never learns about the next season. There used to be a live feed
 * beside it that a calendar app could subscribe to, but that was a URL a server
 * answered, and this app no longer has one.
 */
