...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Nobody can order eighty films; everybody can pick between two. Enough of those and your watchlist sorts itself.",
  noindex: true,
});
    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <ol className="mb-8 space-y-2.5 text-sm text-gray-400">
        ...
        <li className="flex gap-3">
          ...
          <span>
            After a couple of dozen rounds your watchlist has a real order – a
            personal top ten you can share as a link, and a first pick for the
