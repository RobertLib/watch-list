        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="space-y-3 sm:space-y-4 max-w-2xl">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-200 leading-relaxed max-w-xl">
              Discover the latest and greatest TV shows
            </p>
          </div>
        </div>
      </div>
...
function DiscoverTVShowsSkeleton() {
  return (
    <section className="mb-12">
      <h2 className="text-2xl font-bold text-white mb-4">Discover TV Shows</h2>
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="container mx-auto px-6 lg:px-8 py-8">
        <DiscoverTVShowsSkeleton />
        <LoadingSection title="Popular TV Shows" />
        <LoadingSection title="Top Rated TV Shows" />
        <LoadingSection title="Airing Today" />
      </div>
    </div>
  );
}
