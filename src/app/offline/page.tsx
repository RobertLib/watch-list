...
export const metadata: Metadata = pageMetadata({
  title: "Offline",
  description:
    "You are offline. Your watchlist is stored in this browser and is still here.",
  noindex: true,
});
  ...
  return (
    <div className="container mx-auto px-4 py-24 text-center">
      ...
      <p className="text-gray-400 max-w-md mx-auto leading-relaxed">
        WatchList needs a connection to look anything up on TMDb. Your
        watchlist, episode ticks and ratings are all safe in this browser and
